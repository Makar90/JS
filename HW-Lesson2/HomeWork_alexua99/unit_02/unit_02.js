...
function t9() {
    ...
    document.querySelector('.out-9').innerHTML += "<br> document.querySelector('.b-9').onclick = t9;<br>document.querySelector('.i-9').value = '';<br> Не очищає якщо додати після OnClick";
}
...
function t10() {
    if (isNaN(document.querySelector('.i-10').value)) {
        document.querySelector('.out-10').textContent = "Не число";
    } else {
...
function t13() {
    ...
    if (isNaN(a) || isNaN(b)) {
        ...
        out.textContent = a * b;
        /* document.querySelector('.i-13-1').value = document.querySelector('.i-13-2').value = ' '; */
    }
}
...
function t14() {
    if (document.querySelector('.i-14').value != "Go")
        document.querySelector('.i-14').value = "Go";
    else
        document.querySelector('.i-14').value = "это input 14";
}
...
function t15() {
    document.querySelector('.i-15').style.border = "4px dotted red";
}
...
function t16() {
    ...
    let a = parseFloat(document.querySelector('.i-16-1').value);
    let b = parseFloat(document.querySelector('.i-16-2').value);
    out.textContent = a + b;
}
...
function t18() {
    ...
    out.textContent = parseFloat(a.value);
}
...
function t19() {
    ...
    out.textContent = parseFloat(a.value) + parseFloat(b.value);
}
...
function t20() {
    ...
    if (count >= 5)
        ...
        direction = 'up';
    document.querySelector('.b-20').textContent = `TASK-20 Direction- ${direction}`;
